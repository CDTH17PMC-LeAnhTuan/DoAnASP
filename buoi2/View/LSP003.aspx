<%@ Page Title="" Language="C#" MasterPageFile="~/View/GiaoDienChinh.Master" AutoEventWireup="true" CodeBehind="LSP003.aspx.cs" Inherits="buoi2.View.LSP003" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 padding-right">
                    <div class="features_items">
                        ...
                        <asp:Repeater ID="rptSanPham03" runat="server">
                            <ItemTemplate>
                                <div class="col-sm-3">
