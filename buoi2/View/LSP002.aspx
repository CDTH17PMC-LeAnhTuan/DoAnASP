<%@ Page Title="" Language="C#" MasterPageFile="~/View/GiaoDienChinh.Master" AutoEventWireup="true" CodeBehind="LSP002.aspx.cs" Inherits="buoi2.View.LSP002" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 padding-right">
                    <div class="features_items">
                        ...
                        <asp:Repeater ID="rptSanPham02" runat="server">
                            <ItemTemplate>
                                <div class="col-sm-3">
