<%@ Page Title="" Language="C#" MasterPageFile="~/View/GiaoDienChinh.Master" AutoEventWireup="true" CodeBehind="LSP001.aspx.cs" Inherits="buoi2.View.LSP001" %>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 padding-right">
                    <div class="features_items">
                        ...
                        <asp:Repeater ID="rptSanPham01" runat="server">
                            <ItemTemplate>
                                <div class="col-sm-3">
