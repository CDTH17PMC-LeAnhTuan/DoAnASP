...
namespace DAO
{
    public class DAO_GioHang
    {
        ...
        {
            string query = "SELECT GH.MaSP,TenSP,GiaTien,SoLuong,GiaTien*SoLuong AS ThanhTien FROM GioHang GH INNER JOIN SanPham SP ON GH.MaSP = SP.MaSP WHERE TenTaiKhoan = @TenTaiKhoan";
